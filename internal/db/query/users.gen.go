...
func newUsers(db *gorm.DB, opts ...gen.DOOption) users {
	...
	_users.UserID = field.NewString(tableName, "user_id")
	_users.Email = field.NewString(tableName, "email")
	_users.HashedPassword = field.NewString(tableName, "hashed_password")
	_users.FirstName = field.NewString(tableName, "first_name")
	_users.MiddleName = field.NewString(tableName, "middle_name")
	_users.LastName = field.NewString(tableName, "last_name")
	_users.ProfilePicture = field.NewString(tableName, "profile_picture")
	_users.PhoneNumber = field.NewString(tableName, "phone_number")
	_users.Currency = field.NewString(tableName, "currency")
	_users.IsVerified = field.NewBool(tableName, "is_verified")
